...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("RoboBoat 2026 | Mission Formatter v16.1")
    ...
    def draw_grid(self):
        """Restored full 100m grid with 5m increments."""
        self.scene.clear()
    ...
    def handle_selection(self):
        ...
        if sel and isinstance(sel[0], MapItem):
            self.lbl_move_delta.setText(f"Move Delta: {sel[0].get_displacement_m():.2f}m")
